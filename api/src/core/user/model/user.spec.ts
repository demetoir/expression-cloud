...
import { User, UserSetting } from '../../index';
...
describe('user entity', () => {
	...
	describe('relation', () => {
		...
		const getNewUser = async (): Promise<User> => {
			user = UserFactory.build();

			return connection.manager.save(user);
		};

		// it('should relate with role entity', async () => {
		...
		// });
		//
		// it('should relate with notice entity', async () => {
		// 	user = await getNewUser();
		//
		...
		it('should relate with user setting entity', async () => {
			user = await getNewUser();
		...
		// it('should relate with team entity', async () => {
		// 	user = await getNewUser();
		//
		...
		// });
		//
		// it('should relate with edit history entity', async () => {
		// 	user = await getNewUser();
		//
		...
		// });
		//
		// it('should relate with project', async () => {
		// 	user = await getNewUser();
		//
		...
		// });
		//
		// it('should relate with comments', async () => {
		// 	user = await getNewUser();
		//
		...
		// });
		//
		// it('should relate with oauth', async () => {
		// 	user = await getNewUser();
		//
		...
		// });
		//
		// it('should relate like user', async () => {
		// 	user = await getNewUser();
		//
		...
		// it('should relate with user profile image entity', async () => {
		// 	user = await getNewUser();
		//
		...
		// }
		//
		// it('should relate with like expression', async () => {
		// 	user = await getNewUser();
		//
